...
const getFeed = () => {
  ...
  return (
    <Switch>
      ...
      <Route path='/feed' render={(props) => <Feed {...props} signedIn={signedIn} errorMessage={errorMessage} signOut={handleSignOut} onLoad={() => getFeed()} feed={feed} onDelete={handleDelete} />} />
